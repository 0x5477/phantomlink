...
- **双向 P2P 修复（v1.4.1）**：修复仅入站连接时无法回复/发消息/通话的问题，任何一方都可主动发起通信（自动拨号重连）
- **语音消息（v1.4）**：WAV 16-bit PCM 录制，专用加密帧传输，跨平台（含 WKWebView）播放
- **桌面宠物（v1.4）**：《工作细胞》风格红细胞酱/白细胞君/血小板酱，可自由拖动位置，设置中可开关
- **双主题（v1.4）**：日间蓝白浅色主题 / 夜间深空主题，一键切换并持久化
- **在线更新（v1.4.1）**：检查更新/立即更新联动 GitHub Releases，自动下载对应平台安装包
